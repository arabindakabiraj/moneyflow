...
const TTL_URGENT = 24 * 60 * 60 * 1000      // 24 hours — overdue bills, exceeded budgets
const TTL_NORMAL = 3 * 24 * 60 * 60 * 1000   // 3 days — warnings, debts, anomalies
const TTL_MILD   = 7 * 24 * 60 * 60 * 1000   // 7 days — milestones, tips, recurring
