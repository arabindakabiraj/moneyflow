...
export default function DesktopSidebar() {
  ...
  return (
    <aside
      className="hidden lg:flex flex-col h-screen w-64 xl:w-72 sticky top-0 border-r select-none animate-fade-in flex-shrink-0"
      style={{
    ...
    >
      {/* ── Brand Header ── */}
      <div className="p-6 pb-4 border-b border-black/[0.04] dark:border-white/[0.04] flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#4F8EF7] to-blue-600 flex items-center justify-center shadow-md shadow-[#4F8EF7]/20">
        ...
        <div
          className={`flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[9px] font-bold border transition-colors ${
            isOnline
      ...
      <div className="flex-1 overflow-y-auto px-3 py-4 space-y-5 scrollbar-none">
        ...
        <div className="space-y-2">
          <p className="px-3 text-[10px] font-bold uppercase tracking-widest text-gray-400 dark:text-white/35">
            Finance Tools
          </p>
            ...
            {FINANCE_TOOLS.map(({ label, icon: ToolIcon, color, tab }) => {
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-start gap-1.5 p-2.5 rounded-xl border text-left transition-all hover:scale-[1.02] active:scale-[0.98] ${
                    isToolActive
                ...
                >
                  ...
                  <span className={`text-[9px] font-bold leading-tight ${isToolActive ? 'text-[#4F8EF7]' : 'text-gray-500 dark:text-white/50'}`}>
                    {label}
                  </span>
                </button>
              )
      ...
      <div className="p-4 border-t border-black/[0.04] dark:border-white/[0.04] flex items-center justify-between">
        <span className="text-[10px] text-gray-400 dark:text-white/30 font-semibold uppercase">
          MoneyFlow v2.0
        </span>

        {/* Theme Toggler Buttons */}
        <div className="flex bg-black/[0.04] dark:bg-white/[0.04] p-0.5 rounded-lg">
          <button
